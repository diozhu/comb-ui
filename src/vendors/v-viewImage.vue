<!--<template>-->
    <!--&lt;!&ndash; <div class="swiper-container swiperContainer" id="viewImage">-->
	...
	<!--&lt;!&ndash; Add Pagination &ndash;&gt;-->
	    <!--&lt;!&ndash; <div class="swiper-pagination swiper-pagination-white"></div> &ndash;&gt;-->
        <!--<div class="swiper-count">-->
            <!--<span>{{initIndex+1}}</span><em>/</em><span>{{imageUrls.length}}</span>-->
        <!--</div>-->
...
<!--<script>-->
    ...
    <!--//                initialSlide: self.initIndex,-->
                    ...
                    <!--//     console.log('v-viewImage.swiper.onTouchMove: ', self.fingerType, self.swiper.noSwiping);-->
                    ...
                    <!--//         // console.log('v-viewImage.swiper.onTouchMove: ', e.target.style.width, self.swiper.noSwiping);-->
                    <!--//         self.onPinchMove(e, self.direction, {x: x, y: y, dist: dist});-->
                    <!--//     }-->
                    <!--// },-->
                    <!--// onTouchEnd: function (o, e) { // 判断手势、方向-->
                    <!--//     console.log('v-viewImage.swiper.onTouchEnd: ', e.touches.currentX, e.touches.startX);-->
                    <!--//     // if (e.zoom.currentScale !== 1) {-->
                    <!--//     //     console.log('v-viewImage.swiper.zoom.onTouchEnd: ', e.touches);-->
                    <!--//     //     return false;-->
                    <!--//     // }-->
                    <!--//     // 第一张再右滑就返回上一页-->
                    ...
                    <!--// onTap: function (e) {-->
                    <!--//     console.log('v-viewImage.swiper.onTap: ', e);-->
                    <!--// },-->
                    <!--// onDoubleTap: function (e) {-->
                    <!--//     console.log('v-viewImage.swiper.onDoubleTap: ', e);-->
                    <!--// }-->
                <!--});-->
    <!--//            console.log('v-viewImage.mounted: ', this.$root.img, this.swiper);-->
            <!--},-->
            <!--/**-->
             <!--* index中用了右划翻页, 此处阻止冒泡.-->
