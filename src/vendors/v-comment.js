...
//             let result = res.data;
//             console.log('[comments].addComment.SUCCESS: ', result);
//
...
//         console.log('[comments].delComment：');
...
//             let result = res.data;
//             console.log('[comments].delComment.SUCCESS: ', result);
//
//             if (result.Code === 1002) { // token错误
...
//      */
//     getSubject (id) {
//         console.log('[comments].getSubject：', id);
//         if (!id) {
...
//             let result = res.data;
//             console.log('[comments].getSubject.SUCCESS: ', result);
//
//             if (result.Code === 1002) { // token错误
//                 return this.getToken().then(function (res) {
//                     CONFIG.COMMENT_TOKEN = res;
...
//         console.log('[comments].getSubjectList：', newDat);
//         if (!newDat) {
//             // return Promise.reject('无新数据');
...
//             let result = res.data;
//             console.log('[comments].getSubjectList.SUCCESS: ', result);
//
//             if (result.Code === 1002) { // token错误
//                 return _self.getToken().then(function (res) {
//                     CONFIG.COMMENT_TOKEN = res;
...
//         }
//
//         console.log('MicroComment.getComments: ', subjectId, offset, limit);
//
//         params.appId = CONFIG.COMMENT_APPID;
//         params.token = CONFIG.COMMENT_TOKEN;
//         params.userId = parseInt(store.getters.userInfo.id) || 0;
...
//         }
//
//         console.log('MicroComment.getCommentsReply: ', subjectId, offset, limit);
//
//         params.appId = CONFIG.COMMENT_APPID;
//         params.token = CONFIG.COMMENT_TOKEN;
//         params.userId = parseInt(store.getters.userInfo.id) || 0;
...
//         }
//
//         console.log('MicroComment.getPraise: ', subjectId, offset, limit);
//
//         params.appId = CONFIG.COMMENT_APPID;
//         params.token = CONFIG.COMMENT_TOKEN;
//         params.userId = parseInt(store.getters.userInfo.id) || 0;
...
//         return Vue.http.get(uri).then(res => {
//             let result = res.data;
//             console.log('[comments].getCommentsNum.SUCCESS: ', result);
//
//             if (result.Code === 1002) { // token错误
//                 return this.getToken().then(res => {
//                     CONFIG.COMMENT_TOKEN = res;
...
//         return Vue.http.get(uri).then(res => {
//             let result = res.data;
//             console.log('[comments].getPraisesNum.SUCCESS: ', result);
//
//             if (result.Code === 1002) { // token错误
//                 return this.getToken().then(res => {
//                     CONFIG.COMMENT_TOKEN = res;
