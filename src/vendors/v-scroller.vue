<!--<template>-->
    <!--<div v-show="isEnabled"-->
         <!--class="v-scroll"-->
    <!--&gt;-->
        <!--&lt;!&ndash;v-scroll="getList"&ndash;&gt;-->
        <!--&lt;!&ndash;scroll-disabled="isLoading"&ndash;&gt;-->
        <!--&lt;!&ndash;scroll-distance="scrollDistance"&ndash;&gt;-->
        <!--&lt;!&ndash;scroll-enabled="isEnabled"&ndash;&gt;-->
        <!--&lt;!&ndash;scroll-tombstone="tombstone"&ndash;&gt;-->
        <!--&lt;!&ndash;scroll-scrolling-func="scrollingFunc"&ndash;&gt;-->
        <!--&lt;!&ndash;v-scroll-position&ndash;&gt;-->
        <!--<div-->
            <!--:id="'combScroll_'+_uid"-->
            <!--ref="container"-->
            <!--class="v-scroll-container"-->
        <!--&gt;-->
            <!--&lt;!&ndash;:style="{ 'transform': 'translate3d(0, ' + translate + 'px, 0)' }"&ndash;&gt;-->
            <!--&lt;!&ndash; 内容插槽 &ndash;&gt;-->
            <!--&lt;!&ndash;<div ref="content" class="v-scroll-content">&ndash;&gt;-->
            <!--<transition-group name="modal" ref="content" class="v-scroll-content" tag="div">-->
                <!--<slot></slot>-->
                <!--&lt;!&ndash; <slot name="footer" :class="[]"></slot> &ndash;&gt;-->
            <!--&lt;!&ndash;</div>&ndash;&gt;-->
            <!--</transition-group>-->
            <!--&lt;!&ndash; 底部loading && 结束标识 &ndash;&gt;-->
            <!--&lt;!&ndash;<div v-if="typeof endFunc == 'function' || (!refreshTag && (isLoading || (isShowText && scrollEndTxt && currentValue.length > 0)))" class="v-scroll-bottom">&ndash;&gt;-->
            ...
            <!--&gt;-->
                <!--<transition name="fade">-->
                    <!--&lt;!&ndash;<v-spinner v-show="isLoading" color="#BBBAC2" type="triple-bounce"></v-spinner>&ndash;&gt;-->
...
<!--//                refreshTranslate: 0,        // refresh的dom位移-->
        ...
        <!--computed: {-->
            <!--isShowText () {-->
<!--//                console.log('&#45;&#45;&#45;&#45;&#45;&#45;&ndash;&gt; ', this.dataExist, this.isLoadMore);-->
